...
function getDestinationMessage(roomLabel: string | null) {
  ...
  if (roomLabel.toLowerCase().includes('guichê')) {
    return `Dirija-se ao ${roomLabel.toLowerCase()}.`;
  }

  return `Dirija-se ao consultório/sala ${roomLabel.replace(/^(consultório|sala)\s*/i, '')}.`;
}
